...
app.post("/submit", (req, res) => {
  var randIntOne = Math.floor(Math.random()*adj.length);
  var randIntTwo = Math.floor(Math.random()*noun.length);

  var randomAdj = adj[randIntOne];
  var randomNoun = noun[randIntTwo];
